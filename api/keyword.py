...
from subgraph import fetch_subgraph_with_keywords
from subgraph import fetch_subgraph_with_judgements
from subgraph import fetch_subgraph_with_judges
from subgraph import fetch_subgraph_with_subjects
from subgraph import fetch_subgraph_with_year_range
...
graph = import_graph("base_class/LegalKnowledgeGraph.json") 

LegGraph = LegalKnowledgeGraph()
LegGraph.from_nx(graph)
